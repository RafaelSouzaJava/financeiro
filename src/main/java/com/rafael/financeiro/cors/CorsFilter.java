...
public class CorsFilter implements Filter{
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
		...
		if ("OPTIONS".equals(request.getMethod()) && financeiroApiProperty.getOriginPermitida().equals(request.getHeader("Origin"))) {
			response.setHeader("Access_Crontrol-Allow_Methods", "POST, GET, DELETE, PUT, OPTIONS");
			response.setHeader("Access_Crontrol-Allow_Headers", "Authorization, Content-type, Accept");
